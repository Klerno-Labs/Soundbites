...
class QuizAdmin {
    ...
    const ot = document.getElementById('otis-tab');
    if (ot) ot.addEventListener('click', () => this.switchTab('otis'));
    ...
    if (dismissReminder) dismissReminder.addEventListener('click', () => this.dismissQuarterlyReminder());
        ...
        // OTIS Clinical Trial Exports
    const exportTrialCsv = document.getElementById('export-trial-csv');
    if (exportTrialCsv) exportTrialCsv.addEventListener('click', () => this.exportTrialData('csv'));
    const exportTrialReport = document.getElementById('export-trial-report');
    if (exportTrialReport) exportTrialReport.addEventListener('click', () => this.exportTrialData('report'));
    const exportSpss = document.getElementById('export-spss');
    if (exportSpss) exportSpss.addEventListener('click', () => this.exportTrialData('spss'));
    const exportR = document.getElementById('export-r');
    if (exportR) exportR.addEventListener('click', () => this.exportTrialData('r'));
    ...
    exportTrialReport(results, leads) {
        ...
        alert(`📊 OTIS Clinical Trial Statistical Report\n\nGenerated: ${new Date().toLocaleString()}\n\n` +
              `Sample Size (N): ${n}\n` +
